...
namespace Ex04.Menus.Interfaces
{
    public class SubMenu : MenuItem
    {
        ...
        public SubMenu(string i_Title) : base(i_Title)
        {
            ...
            this.AddItem(new LeafItem(k_TitleOfBackMenuItem));
        }
        ...
        private string getUserOptionChoice()
        {
            ...
            while (!isValidChoiceFromOptions(userOptionChoice))
            {
        ...
        private bool isValidChoiceFromOptions(string i_UserOptionChoice)
        {
        ...
        private void printMenuItemsList()
        {
            if (MenuItems.Count > 1)
            {
        ...
        {
            int numOfNewItemInMenuItemsList;

            this.MenuItems.Add(i_NewMenuItem);
            numOfNewItemInMenuItemsList = MenuItems.Count - 1;
            i_NewMenuItem.OptionNumberInMenu = numOfNewItemInMenuItemsList;
            ...
            this.m_MenuItems[numOfNewItemInMenuItemsList].PreviousMenuItem = this;
        }
    }
}
